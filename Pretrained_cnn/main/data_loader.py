...
"""
This is a file for loading the plant leaf dataset.
"""
...
if __name__ == '__main__':
    ...
    dataset = LeafDataset(base_path, train_txt, image_size=(128, 128), mode='train')
    ...
    dataset = LeafDataset(base_path, validate_txt, image_size=(128, 128), mode='validate')
    ...
    dataset = LeafDataset(base_path, test_txt, image_size=(128, 128), mode='test')
